...
BlockFactory.STARTER_BLOCK_XML_TEXT =
    ...
    '<field name="HUE">250</field>' +
    '</block></value></block></xml>';*/

BlockFactory.STARTER_BLOCK_XML_TEXT =
    '<xml xmlns="https://developers.google.com/blockly/xml">\n' +
    '  <block type="DOMAINCONCEPT" id="/)MzzH}a^?[,WzW*~[!3" deletable="false" movable="false">\n' +
    '    <field name="DM_abbrev">T</field>\n' +
    '    <field name="DM_description">some description</field>\n' +
    '    <field name="DM_concepts">Report</field>\n' +
    '    <field name="DM_compositions"></field>\n' +
    '  </block>\n' +
    '</xml>';
...
BlockFactory.updatePreview = function() {
  ...
  try {
    ...
    //BlockFactory.updateGenerator(previewBlock); //we do not use this anymore
...
BlockFactory.isStarterBlock = function() {
  ...
  return rootBlock && !(
      ...
      rootBlock.getFieldValue('DM_name').trim().toLowerCase() != 'test' ||
